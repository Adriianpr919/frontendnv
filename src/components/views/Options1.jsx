          ...
          <div className="row">
            ...
            <div className="col-6">
              <div className="page-title-wrap">
                <h1>
                  <FontAwesomeIcon icon="fa-solid fa-gear" /> T&#201;RMINOS Y CONDICIONES. :*
                </h1>
              </div>
            </div>
            {/* Page Title Area End */}
            ...
            <div className="col-lg-12 order-last order-lg-first">
              <div className="about-text-wrap">
                ...
                <p style={{ textAlign: "justify" }} lang="es"><hr className="my-10" />
                  ...
                  <br />
                  PARÁGRAFO PRIMERO: La aceptación de la oferta se realizará por medio de correo electrónico dirigido a la dirección suministrada por parte del cliente por medio de la expresión “muchas gracias por su compra” u otra similar. Debe tener en cuenta nuestro cliente, que el solo registro, el suministro de la clave personal a nuestro cliente o la remisión de la información o transacción no significa aceptación de ninguna oferta.
                  <br />
                  ...
                  <br />
                  Se exceptúan del siguiente caso y según el objeto social que desempeña, los siguientes casos:
                  <br />
                  ...
                  <br />
                  POLITICAS DE ENVIOS, CAMBIOS, DEVOLUCIONES Y GARANTÍAS:
                  <br />
                  TIEMPOS DE ENTREGA:
                  El tiempo de entrega de los productos es aproximadamente (Dentro de Villavicencio (Meta) 2 días máximo) a nivel nacional 6 días hábiles y a nivel internacional de 10 a 20 días hábiles, dependiendo la firma de transporte asignada. Los tiempos de entrega empiezan a contar a partir de la confirmación del pago.
                  <br />
                  Para pagos con:
                  <br />
                  1.Tarjetas crédito:
                  ...
                  3. Baloto,<br /> 4. Discover,<br /> 5. PayPal,<br /> 6. Efecty,<br /> 7. PayU Y MUCHOS MÁS.
                  <br />
                  la información de pago se puede tardar hasta 1 día hábil después de efectuado el pago. Para pago contra entrega los tiempos empiezan a contar inmediatamente después de realizada la compra. En el momento de la aprobación del pago de tu orden, recibirás un correo electrónico con la confirmación del mismo. Las entregas no se pueden realizar en un horario exacto. En caso de que tengas alguna inquietud con el despacho del producto puedes comunicarte con la línea de Servicio al cliente de Nury Valenzuela&#174; Joyer&iacute;a al +57-3133966349 (en horario de lunes a viernes de 9am-6pm), o a través de nuestro correo: nuryvalenzuelajoyeria@gmail.com, o en nuestro sitio web https://www.nuryvalenzuelajoyeria.com/ en el formulario de ‘Contáctanos’ para verificar el estado del transporte. El producto podrá ser recibido por cualquier persona mayor de edad que habite o esté presente en el lugar de entrega, para lo cual bastará la firma de la guía del transportador.
                  <br />
                  En caso que el producto tenga señas de daños o rupturas en su empaque en el momento de la entrega, debes registrarlo en la guía del transportador como una observación y comunicarte con la línea de Servicio al cliente de +57-3133966349 (en horario de lunes a viernes de 9am-6pm), a través de nuestro correo: nuryvalenzuelajoyeria@gmail.com, o en nuestro sitio web https://www.nuryvalenzuelajoyeria.com/ en el formulario de ‘Contáctanos’.
                  <br />
                  COBERTURA Para entrega de productos de forma directa e indirecta, Nury Valenzuela&#174; Joyer&iacute;a aplicara las siguientes políticas: Entrega sin recargo adicional directamente en el Showroom, y se entregará únicamente al comprador o una persona delegada bajo autorización escrita, adjuntando comprobante de pago y orden de pedido aprobada. Entrega de productos a Clientes directamente de la Joyería en la Ciudad de Villavicencio (Meta). Este servicio tendrá un recargo de Tarifas que se ajustan a tu negocio 3,49% + 800, Para cuentas nacionales, a partir del 4to retiro tendrá un costo de $6,500 COP + IVA. Toda entrega fuera del perímetro citado o a nivel Nacional en las principales ciudades, se efectuará a través de las firmas de transporte con las que Nury Valenzuela&#174; Joyer&iacute;a tiene convenios de distribución que garantizan la seguridad y cobertura, para que tu compra llegue a la dirección que desees. (ver tarifas de fletes) Para las entregas a Clientes exclusivos o mercancía de mayor valor dentro y fuera de la ciudad de Villavicencio (Meta), se informará al Cliente los gastos de viáticos y transportes para la entrega especial de los productos adquiridos en Nury Valenzuela&#174; Joyer&iacute;a
                  <br />
                  COSTO DEL ENVÍO El envío de los pedidos el costo del envío será determinado en cada caso particular dependiendo del destino, peso y volumen del paquete. Este valor se calculará en el proceso de la compra y te será informado en el momento de la liquidación de la orden, antes de que realices el pago.
                  <br />
                  POLÍTICAS DE CAMBIO Si deseas hacer el cambio de alguno de nuestros productos, lo puedes hacer de dos maneras: directamente en el Showroom de Nury Valenzuela&#174; Joyer&iacute;a, presentando tu factura de compra, (Dentro de Villavicencio (Meta) 2 días máximo) a nivel nacional 6 días hábiles y a nivel internacional de 10 a 20 días hábiles, luego de la fecha en que fue efectuada la compra, o a través de nuestro sitio web https://www.nuryvalenzuelajoyeria.com/, (Dentro de Villavicencio (Meta) 2 días máximo) a nivel nacional 6 días hábiles y a nivel internacional de 10 a 20 días hábiles,) luego de la entrega del producto.
                  <br />
                  ...
                  <br />
                  Cambios a través de "sitio web https://www.nuryvalenzuelajoyeria.com/":
                  <br />
                  Si deseas hacer el cambio a través de sitio web https://www.nuryvalenzuelajoyeria.com/, (Dentro de Villavicencio (Meta) 2 días máximo) a nivel nacional 6 días hábiles y a nivel internacional de 10 a 20 días hábiles, luego de haber recibido el producto, debes ponerte en contacto con el área de Servicio al cliente de +57-3133966349 (en horario de lunes a viernes de 9am-6pm), a través de nuestro correo: nuryvalenzuelajoyeria@gmail.com, o en nuestro sitio web https://www.nuryvalenzuelajoyeria.com/ en el formulario de ‘Contáctanos’.
                  <br />
                  Una vez hayas solicitado la devolución de tu producto podrás escoger entre las siguientes opciones:
                  <br />
                  Cambio del producto por talla o acabado: sólo se podrán realizar cambios por productos con valor igual o inferior al original, el cambio estará sujeto a la disponibilidad en el inventario. (en caso que el valor sea inferior se enviará el saldo restante en un bono para realizar una nueva compra online)
                  <br />
                  Bono o nota crédito para realizar una nueva compra sitio web https://www.nuryvalenzuelajoyeria.com/ (este bono tendrá vigencia de seis (6) meses). Devolución del dinero únicamente acorde al derecho de retracto consagrado por la ley 1480 de 2011 art. 47. Para hacer la devolución del envío DEBES utilizar el mismo empaque en que te entregamos tu pedido.
                  <br />
                  Una vez recibamos tu producto de vuelta en nuestra bodega, verificaremos las condiciones en que se encuentra el producto, Nury Valenzuela&#174; Joyer&iacute;a (Dentro de Villavicencio (Meta) 2 días máximo) a nivel nacional 6 días hábiles y a nivel internacional de 10 a 20 días hábiles, para informarte si tu producto cumple con las con los criterios establecidos para hacer el cambio por talla o acabado, por bono o nota crédito para otro producto.
                  <br />
                  ...
                  <br />
                  Bono o nota crédito para realizar una nueva compra en sitio web https://www.nuryvalenzuelajoyeria.com/ será enviado a tu correo dos (2) días hábiles después recibido el producto en nuestra bodega.
                  <br />
                  ...
                  <br />
                  d. Eximo a de toda responsabilidad por la información errónea, falsa, inexacta que se hubiese suministrado en este documento o por la violación del mismo, de tal suerte que seré el único responsable por ello.
                </p>
              </div>
            </div>
            {/* About Text End */}
