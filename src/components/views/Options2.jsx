            ...
            <div className="col-lg-12 order-last order-lg-first">
              <div className="about-text-wrap">
                ...
                <p style={{ textAlign: "justify" }} lang="es"><hr className="my-10" />
                  ...
                  <br />
                  Los tiempos de entrega empiezan a contar a partir de la confirmación del pago. Para pagos con tarjeta de crédito y utilizando el botón PayU, la plataforma de pagos deberá aprobar la transacción de acuerdo con el análisis de los datos, lo cual puede tardar hasta un día hábil.
                  <br />
                  Para pagos con Efecty la información de pago se puede tardar hasta 1 día hábil después de efectuado el pago. Para pago contra entrega los tiempos empiezan a contar inmediatamente después de realizada la compra.
                  <br />
                  ...
                  COSTO DEL ENVÍO:
                  <br />
                  El envío de los pedidos el costo del envío será determinado en cada caso particular dependiendo del destino, peso y volumen del paquete. Este valor se calculará en el proceso de la compra y te será informado en el momento de la liquidación de la orden, antes de que realices el pago.
                  <br />
                  POLÍTICAS DE CAMBIO:
                  <br />
                  ...
                  <br />
                  Cambios a través de https://www.nuryvalenzuelajoyeria.com/:
                  <br />
                  Si deseas hacer el cambio a través de https://www.nuryvalenzuelajoyeria.com/, (Dentro de Villavicencio (Meta) 2 días máximo) a nivel nacional 6 días hábiles y a nivel internacional de 10 a 20 días hábiles, luego de haber recibido el producto, debes ponerte en contacto con el área de Servicio al cliente de +57-3133966349  (en horario de lunes a viernes de 9am-6pm), a través de nuestro correo nuryvalenzuelajoyeria@gmail.com, o en nuestra página web https://www.nuryvalenzuelajoyeria.com/ en el formulario de ‘Contáctanos’.
                  <br />
                  Una vez hayas solicitado la devolución de tu producto podrás escoger entre las siguientes opciones:
                  <br />
                  Cambio del producto por talla o acabado: sólo se podrán realizar cambios por productos con valor igual o superior al original, el cambio estará sujeto a la disponibilidad en el inventario. (en caso que el valor sea superior se enviará el saldo faltante a cancelar.)
                  <br />
                  ...
                  <br />
                  &#45;&#41; Cambio del producto por talla o acabado: se despachará dos (2) días hábiles después de haber recibido el producto en nuestra bodega y a partir de este momento aplican los mismos tiempos que para una entrega normal.
                  <br />
